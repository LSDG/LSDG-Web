...
var paraText = document.createTextNode("Dan and Dan are dans!");
// and add them as child nodes to the new elements
newHeading.appendChild(h1Text);
newParagraph.appendChild(paraText);

// and we still need to attach them to the document!
document.getElementById("abovefooter").appendChild(newHeading);
document.getElementById("abovefooter").appendChild(newParagraph);
